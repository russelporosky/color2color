 ...
 * @see {@link detectors.ColorDetectors}
 */
export declare type ColorDefinitions = {
 ...
 */
export declare type ColorDefinitionType = `${ColorDefinitionName | ColorName}`;
/**
 ...
 */
export declare enum ColorDefinitionName {
    HEX3 = "hex3",
    HEXA4 = "hexa4"
}
/**
 ...
 */
export declare type ColorType = `${ColorName}`;
/**
 * This reflects the output shape of the color {@link colors.ColorDefinition.normalize} method.
 */
export declare type ConverterTuple = [number | string, number, number, number];
export declare type HexConverter = ([r, g, b]: [number, number, number]) => ColorModel;
export declare type HexaConverter = ([r, g, b, a]: [
    number,
    number,
    number,
    number?
]) => ColorModel;
export declare type HsbConverter = ([h, s, b]: [string, number, number]) => ColorModel;
export declare type HslConverter = ([h, s, l]: [string, number, number]) => ColorModel;
export declare type HslaConverter = ([h, s, l, a]: [
    string,
    number,
    number,
    number?
]) => ColorModel;
export declare type HsvConverter = ([h, s, v]: [string, number, number]) => ColorModel;
export declare type HwbConverter = ([h, w, b]: [string, number, number]) => ColorModel;
export declare type HwbaConverter = ([h, w, b, a]: [
    string,
    number,
    number,
    number?
]) => ColorModel;
export declare type RgbConverter = ([r, g, b]: [number, number, number]) => ColorModel;
export declare type RgbaConverter = ([r, g, b, a]: [
    number,
    number,
    number,
    number?
 ...
 */
export declare type Converter = HexConverter | HexaConverter | HsbConverter | HslConverter | HslaConverter | HsvConverter | HwbConverter | HwbaConverter | RgbConverter | RgbaConverter;
/**
 ...
 */
export declare type ColorModel = HEXA | HSB | HSLA | HSV | HWB | RGBA;
